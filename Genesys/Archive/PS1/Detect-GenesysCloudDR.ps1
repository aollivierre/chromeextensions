# Detect-GenesysCloudDR.ps1
# SCCM Detection script for Genesys Cloud DR shortcut
# 
...
# Configuration
$shortcutTitle = "Genesys Cloud DR (Chrome)"
$expectedTargets = @(
    "C:\Program Files\Google\Chrome\Application\chrome.exe",
    "C:\Program Files (x86)\Google\Chrome\Application\chrome.exe"
)
# Updated URL for POC testing
$expectedArguments = "--app=https://www.toronto.ca/"
...
if (-not $remediationNeeded) {
    ...
    Write-Host "Genesys Cloud DR shortcut is properly configured. No remediation needed."
}
...
# $detectionDetails | Out-File -FilePath "$logFolder\detection_log_dr.txt" -Append 